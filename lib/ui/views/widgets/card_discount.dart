  ...
  Widget build(BuildContext context) {
    return
      ...
      Padding(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                             ...
                             Container(
                                  ...
                                  color: Colors.teal,
                                  // child: Image.network(
                                  //     '${_baseUrl}${_productController.productModel!.products![0].productImage.toString()}'),
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Container(
                                                ...
                                                child: TextButton(
                                                    onPressed: () {
                                                     // _productController.addtoCart(_productController.productModel!.products![index].id!.toInt());
                                                      // print(_productController.productModel!.products![index].id.toString());
                                                       print(index);
                                                    },
        ...
        //                       //                 image: DecorationImage(
        //                       //                     image: NetworkImage(
        //                       //                         '${_baseUrl}${controller.lstTask[index]["ProductImage"].toString()}'==null?
        //                       //                         "":
        //                       //                         '${_baseUrl}${controller.lstTask[index]["ProductImage"].toString()}'),
        //                       //                     fit: BoxFit.cover),
        //                       //               ),
        ...
        //                       //                                   //     .categoryName
        //                       //                                   //     .toString()
        //                       //                                   controller.lstTask[index]["ProductImage"].toString()
        //                       //                                   ,
        //                       //                                   style: TextStyle(
        //                       //                                       fontSize: 10.sp,
        //                       //                                       color:
    ...
    //                           child: Row(
    //                             children: [
    //                               _productController.productModel!
